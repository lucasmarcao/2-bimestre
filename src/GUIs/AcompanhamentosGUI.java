...
public class AcompanhamentosGUI extends JDialog {
    ...
    JLabel lbId = new JLabel("ID ACOMPANHAMENTO");
    ...
    JLabel lbNome = new JLabel("Nome do Produto", JLabel.CENTER);
    JTextField tfNome = new JTextField(30);
    JLabel lPlanetaDoAlien = new JLabel("ID do Fornecedor", JLabel.CENTER);
    ...
    public AcompanhamentosGUI() {
        ...
        botaosalvar.addActionListener((ActionEvent ae) -> {
            try {
                ...
                if (acao.equals("adicionar")) {
                    ...
                    acompanhamentos.setNomeaconpanhamento(tfNome.getText());
                    ...
                    acompanhamentos.setIdacompanhamentos(id2);
                    acompanhamentos.setNomeaconpanhamento(tfNome.getText());
        ...
        botaolistar.addActionListener((ActionEvent ae) -> {
            List<Acompanhamentos> acompanhamentos1 = daoAcompanhamentos.list();
